...
| `/spec-gate migrate`  | Brownfield 7-phase: reverse-generate Charter, Spec (SpecKit-standard 7-file), Constitution, Glossary, then Finalize (strip working metadata)  | `docs/domains/*/charter.md`, `specs/<NNN>-<DOM>-<slug>/` (post-finalize), `docs/glossary.md`                    |
